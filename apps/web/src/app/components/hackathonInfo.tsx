        ...
        <Grid container rowSpacing={4} columnSpacing={10}>
          ...
          <Grid item xs={12} md={6} lg={6}>
            <Box className="border-4 border-black rounded-3xl bg-white py-5 xl:px-8 h-full xl:w-5/6 justify-center items-center flex flex-col text-center">
              ...
              <Typography className="xl:px-16 xl:py-5 xl:text-2xl px-2 py-2">Co-hosting with EduX and BuZhiDAO, we are delivering the very first student-only hackathon in Taiwan in May-July 2024!</Typography>
